<section class="use-cases">
	...
	<div class="row">
		...
		<div class="columns small-12 medium-10 medium-offset-1 large-12 large-offset-0">
			...
			<p class="lead use-cases__lead">Mantl is used to solve DevOps, business and team challenges.<br> Here are some of the primary use cases.</p>	
